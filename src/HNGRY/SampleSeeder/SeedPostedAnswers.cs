namespace HNGRY.SampleSeeder
{
	...
	public class SeedPostedAnswers
	{
		...
		public async Task InsertPostedAnswers()
		{
			...
			{
				await this._appRepository.AddPostedAnswer("Dale Faux", "Seriously, no more Dunkaroos.  Those are so 1988.");
				await this._appRepository.AddPostedAnswer("Bonnie Louis", "Bon voyage to all of Sean Walsh's requests for carrots since he has decided to bring his own.");
			}
		}
	}
}